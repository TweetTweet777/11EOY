...
DIM SEWAGE(21) AS INTEGER
DIM RUBBISH(21) AS INTEGER
DIM WATER.CHG(4) AS SINGLE
DIM DISC.CHG(21) AS SINGLE
DIM TOTAL.CHG(21) AS SINGLE
...
DATA "N"
DATA "JOHN DOE",-1,1000,1,1
DATA "JOHN DOE",0,1000,1,1
DATA "JOHN DOE",1,1000,1,1
DATA "JOHN DOE",9,1000,1,1
DATA "JOHN DOE",10,1000,1,1
DATA "JOHN DOE",11,1000,1,1
DATA "JOHN DOE",9,-1,1,1
DATA "JOHN DOE",9,0,1,1
DATA "JOHN DOE",9,1,1,1
DATA "JOHN DOE",9,3999,0,0
DATA "JOHN DOE",9,4000,0,0
DATA "JOHN DOE",9,4001,0,0
DATA "JOHN DOE",9,9999,0,0
DATA "JOHN DOE",9,10000,0,0
DATA "JOHN DOE",9,10001,0,0
DATA "JOHN DOE",9,1000,1,1
DATA "JOHN DOE",9,1000,0,1
DATA "JOHN DOE",9,1000,1,0
DATA "JOHN DOE",9,1000,0,0
DATA "JOHN DOE",9,1000,1,0
DATA "JOHN DOE",9,1000,1,0
...
SOFT.PRINT:
    ...
    FOR COLUMN% = 1 TO UBOUND(F.NAME)
        ...
        ELSE
            PRINT USING "## #####,.##L # # $$###,.## $$#####,.##"; TAB(15); YEARS(COLUMN%); TAB(23); USAGE(COLUMN%); TAB(38); SEWAGE(COLUMN%); TAB(49); RUBBISH(COLUMN%); TAB(55); DISC.CHG(COLUMN%); TAB(66); TOTAL.CHG(COLUMN%)
        END IF
    NEXT COLUMN%
    PRINT STRING$(80, 45)
    PRINT TAB(3); "Total Accumulated Charges = ";
    PRINT USING "$##,###.##"; TAB(66); ACC.CHG!
...
HARD.PRINT:
    ...
    FOR COLUMN% = 1 TO UBOUND(F.NAME)
        ...
        ELSE
            LPRINT USING "## #####,.##L # # $$###,.## $$#####,.##"; TAB(15); YEARS(COLUMN%); TAB(23); USAGE(COLUMN%); TAB(38); SEWAGE(COLUMN%); TAB(49); RUBBISH(COLUMN%); TAB(55); DISC.CHG(COLUMN%); TAB(66); TOTAL.CHG(COLUMN%)
        END IF
    NEXT COLUMN%
    LPRINT STRING$(80, 45)
    LPRINT TAB(3); "Total Accumulated Charges = ";
    LPRINT USING "$$#####,.##"; TAB(66); ACC.CHG!
